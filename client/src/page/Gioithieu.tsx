...
const Gioithieu = () => {
  return (
    <div>
      ...
      <div className="page-gt container">
        <h4 className="page-header">Giới thiệu</h4>
        <div className="page-info">
          <p>
            ...
            tại Tòa nhà Sông Đà, Phạm Hùng, Hà Nội.
          </p>
          <br />
          <p>
            ...
            thỏa mãn với tất cả các sản phẩm của mình.
            <br />
            ...
            hãng với chất lượng đảm bảo và uy tín cũng như giá cả hợp lý nhất.
            <br />
