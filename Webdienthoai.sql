...
--
-- Dumping routines for database 'webdienthoai'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Create_Cart`(in `@user_id` int, in `@product_id` int, in `@quantity` int)
BEGIN
...
in `@user_id` int, in `@status` varchar(255), in `@create_at` varchar(255),
in `@name` varchar(255), in `@email` varchar(255), in `@phone` varchar(255),
in `@province` varchar(255), in `@district` varchar(255), in `@ward` varchar(255), in `@address` varchar(255) )
BEGIN
 INSERT INTO orderr (user_id, status, create_at, name, email, phone, province, district, ward, address)
 VALUES (`@user_id`, `@status`, `@create_at`, `@name`, `@email`, `@phone`, `@province`, `@district`, `@ward`, `@address`);
 
  -- Lấy giá trị order_id cuối cùng
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Create_Order_Product` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Create_Order_Product`(
in `@last_order_id` int, in `@product_id` int, in `@product_name` varchar(255),in `@product_img` varchar(255),
in `@product_quantity` int, in `@product_price` int, in `@product_sale` double)
BEGIN
INSERT INTO `order_product` ( `order_id`, `product_id`, `product_name`, `product_img`, `product_quantity`, `product_price`, `product_sale`)
VALUES (`@last_order_id`, `@product_id`, `@product_name`, `@product_img`, `@product_quantity`, `@product_price`, `@product_sale`);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Create_User`(
	...
	in `@status` int)
BEGIN
	INSERT INTO users (username,email,passwords,status) VALUES (`@username`,`@email`,`@passwords`,`@status`);
    INSERT INTO profile (user_id) VALUES (LAST_INSERT_ID());
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteOrder`(in `@order_id` int)
BEGIN
DELETE FROM `webdienthoai`.`orderr` WHERE (`order_id` = `@order_id`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Delete_Cart`(in `@cart_id` int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Delete_Cart_ByUser` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Delete_Cart_ByUser`(in `@user_id` int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetAllByCategory` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllByCategory`(in `@category` varchar(255))
BEGIN
...
BEGIN
SELECT * FROM webdienthoai.category;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT o.*,u.username,u.email FROM ORDERR o JOIN users u ON o.user_id = u.user_id ORDER BY status ASC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetAllProductByPagination` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllProductByPagination`(in `@page_number` int, in `@page_index` int, in `@category` varchar(255))
BEGIN
	SELECT p.product_id, p.name, p.price, p.sale, p.count, c.name as category,m.img, pd.screen,pd.star, pd.os, pd.camara, pd.camaraFront, pd.cpu, pd.ram, pd.rom, pd.sim, pd.battery 
		  FROM products p 
		  JOIN product_detail pd ON p.product_id = pd.product_id 
		  JOIN category c ON p.category_id = c.category_id 
		  JOIN media m ON p.product_id = m.product_id
		  WHERE IF(`@category` IS NOT NULL AND `@category` != '',
      c.name = `@category`,
      TRUE
    )
		  ORDER BY p.product_id ASC
		  LIMIT `@page_number` OFFSET `@page_index`;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT u.*,p.* FROM users u JOIN profile p ON u.user_id = p.user_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetCountProduct` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCountProduct`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetOneCart` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOneCart`(in `@user_id` int)
BEGIN
SELECT c.cart_id, c.user_id, c.product_id, c.quantity, p.name, m.img, p.price , p.sale, p.count
FROM cart c
JOIN products p ON c.product_id = p.product_id
JOIN media m ON c.product_id = m.product_id
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetOneOrder` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOneOrder`(in `@order_id` int)
BEGIN
SELECT p.*,m.img FROM order_product p JOIN media m ON p.product_id = m.product_id WHERE p.order_id = `@order_id`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOneProduct`(in `@product_id` int)
BEGIN
SELECT p.product_id, p.name, p.count, p.price, p.sale, c.name AS category, m.img, c.description, pd.screen, pd.os, pd.camara, pd.camaraFront, pd.cpu, pd.ram, pd.rom, pd.sim, pd.battery, pd.star
FROM products p
JOIN category c ON c.category_id = p.category_id
JOIN product_detail pd ON p.product_id = pd.product_id
JOIN media m ON p.product_id = m.product_id
LEFT JOIN product_rate pr ON p.product_id = pr.product_id
WHERE p.product_id = `@product_id`
GROUP BY p.product_id, p.name, m.img;
SELECT pr.user_id, u.username, pr.comment, pr.create_at 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetOneUser` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOneUser`(in `@user_id` int)
BEGIN
SELECT u.*,p.* FROM users u JOIN profile p ON u.user_id = p.user_id WHERE u.user_id = `@user_id`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT p.product_id, p.name, p.count, p.price, p.sale, COUNT(pr.comment) AS count_comment, c.name as category, m.img, c.description,pd.screen, pd.os, pd.camara, pd.camaraFront, pd.cpu, pd.ram, pd.rom, pd.sim, pd.battery, pd.star
FROM products p
JOIN category c ON c.category_id = p.category_id
JOIN product_detail pd ON p.product_id = pd.product_id
JOIN media m ON p.product_id = m.product_id
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Product_Get_Category` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Product_Get_Category`(in `@category` varchar(255))
BEGIN
SELECT p.product_id, p.name, p.price, p.sale, p.count, c.name as category,m.img, pd.screen, pd.os, pd.camara, pd.camaraFront, pd.cpu, pd.ram, pd.rom, pd.sim, pd.battery 
        FROM products p 
        JOIN product_detail pd ON p.product_id = pd.product_id 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateOrderStatus`(in `@status` varchar(255), in `@order_id` int)
BEGIN
UPDATE `webdienthoai`.`orderr` SET `status` = `@status` WHERE (`order_id` = `@order_id`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateProduct`(in `@product_id` int, in `@name` varchar(255), in `@price` int, in `@sale` double, in `@count` int, in `@category` int, in `@img` varchar(255),
in `@screen` varchar(255), in `@os` varchar(255), in `@camara` varchar(255), in `@camaraFront` varchar(255), in `@cpu` varchar(255), in `@ram` varchar(255),
in `@rom` varchar(255), in `@sim` varchar(255), in `@battery` varchar(255))
BEGIN
UPDATE `webdienthoai`.`products` 
SET `name` = `@name`,`category_id`= `@category`, `price` = `@price`,
 `sale` = `@sale`, `count` = `@count` WHERE (`product_id` = `@product_id`);
UPDATE `webdienthoai`.`product_detail` 
SET `screen` = `@screen`, `os` = `@os`,
 `camara` = `@camara`, `camaraFront` = `@camaraFront`,
 `cpu` = `@cpu`, `ram` = `@ram`,
 `rom` = `@rom`, `sim` = `@sim`,
 `battery` = `@battery` WHERE (`product_id` = `@product_id`);
UPDATE `webdienthoai`.`media` SET `img` = `@img` WHERE (`product_id` = `@product_id`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateStatus`(in `@status` int, in `@user_id` int)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Update_Cart`(in `@quantity` int, in `@user_id` int, in `@product_id` int)
BEGIN
  DECLARE current_quantity INT;
  -- Lấy số lượng hiện tại của sản phẩm từ bảng `cart`
  SELECT quantity INTO current_quantity FROM cart WHERE user_id = `@user_id` and `product_id` = `@product_id`;
  -- Cộng thêm số lượng mới với số lượng hiện tại
  SET current_quantity = current_quantity + `@quantity`;

UPDATE `webdienthoai`.`cart` SET `quantity` = current_quantity  WHERE (`user_id` = `@user_id` and `product_id` = `@product_id`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Update_Quantity_Giam` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Update_Quantity_Giam`(in `@quantity` int, in `@user_id` int, in `@product_id` int)
BEGIN
 DECLARE current_quantity INT;
  -- Lấy số lượng hiện tại của sản phẩm từ bảng `cart`
  SELECT quantity INTO current_quantity FROM cart WHERE user_id = `@user_id` and `product_id` = `@product_id`;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Update_Quantity_Tang` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Update_Quantity_Tang`(in `@quantity` int, in `@user_id` int, in `@product_id` int)
BEGIN
 DECLARE current_quantity INT;
  -- Lấy số lượng hiện tại của sản phẩm từ bảng `cart`
  SELECT quantity INTO current_quantity FROM cart WHERE user_id = `@user_id` and `product_id` = `@product_id`;
...
-- Dump completed on 2023-10-29 21:23:47
